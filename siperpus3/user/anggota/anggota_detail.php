    ...
    <div class="panel-body">
       ...
       <div class="col-lg-12">
          <div class="card-header">
            <strong>Anggota Detail</strong><a href="?user=anggota" class="col-cyan waves-effect pull-right"><font color="blue">Lihat Data</a></div></font>
          <div class="card">
            <div class="col-md-12">
                <form id="form_validation" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" id="nama" class="form-control" placeholder="NAMA" name="nama_anggota" value="<?php echo $tampil['nama_anggota']?>" oninput="fungsinama()" disabled   />
                    </div>


                    <div class="form-group">
                        <label>Foto</label>
                        <input  name="foto" id="foto" class="form-control" type="file"  accept="images/*" onchange="preview_foto(event)"  value="<?php echo $tampil['foto']?>" disabled />
                    </div>

                    <div class="form-group">
                        <label>Username</label>
                        <input type="text" id="username" name="username" placeholder="USERNAME" class="form-control" value="<?php echo $tampil['username']?>" disabled  />
                    </div>

                    <div class="form-group">
                        <label>Password</label>
                        <input type="password" id="password" name="password" placeholder="PASSWORD" class="form-control" value="<?php echo $tampil['password']?>" disabled  />
                    </div>

                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input class="form-control" id="tgl_lahir" placeholder="TGL LAHIR" name="tgl_lahir" value="<?php echo $tampil['tgl_lahir']?>" type="date" disabled  />
                    </div>

                   <div class="form-group">
                    <label>Jenis Kelamin</label>
                    <select class="form-control" id="jk" name="jk" oninput="fungsijk()" disabled/>
                ...
                <div class="form-group">
                    <label>Jurusan</label>
                    <select class="form-control" id="jurusan" name="jurusan" oninput="fungsijurusan()" disabled/>

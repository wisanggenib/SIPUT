...
<div align="left" class="control-group">
    ...
    <center><img src="images/logosmk.png" height="150" width="150">
    ...
    <div class="panel-body">
        <form role="form" method="POST">
          ...
          <a href="index_user.php" class="btn btn-danger btn-primary"><i class="fa fa-home"></i>Home</a> </div>
             
            <hr />
            Login Admin ? <a href="login.php" > Klik disini </a>
...
<?php
  ...
  if (isset($_POST['login'])) {
    ...
    $sql = $koneksi->query("select * from tb_anggota where username='$username' and password='$password'");

            ...
            <div class="col-md-12">
                <form id="form_validation" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>NIS/NIP</label>
                        <input type="text" id="nis" oninput="fungsinis()"  class="form-control" maxlength="12" placeholder="NIS/NIP" value="<?php echo $tampil['nis_nip']?>" name="nis_nip" required onkeypress="return Angkasaja(event)"/>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Foto</label>
                        <input  name="foto" id="foto" type="file" class="form-control"  accept="images/*" onchange="preview_foto(event)"  value="<?php echo $tampil['foto']?>"/>
                    </div>

                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input class="form-control" id="tgl_lahir" placeholder="TGL LAHIR" name="tgl_lahir" value="<?php echo $tampil['tgl_lahir']?>" type="date" required  />
                    </div>
